        ...
        <div className="container-fluid" id="container" ref={containerRef}>
            ...
            <div className="user-details">
                ...
                <div style={{ color: '#4b5563' }}>
                    ...
                    {`Class ${publisherClassList.find(i => i.id === form.class_id)?.title || "NA"} · Subject: ${subjectList.find(i => i.id === form.subject_id)?.title || "NA"} · Chapter: ${chapterList.find(i => i.id === form.chapter_id)?.title || "NA"}`}
                </div>
            </div>
